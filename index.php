    ...
    <div id="app">
        ...
        <header id="header">
            ...
            <div class="header-icons">
                <button id="rules-btn" class="pill-btn" title="Regras">
                    ...
                    <span class="pill-label">Regras</span>
                </button>
                <button id="history-btn" class="pill-btn" title="Histórico">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    <span class="pill-label">Histórico</span>
                </button>
                <span id="refresh-dot" title="A actualizar…"></span>
                <button id="gear-btn" class="pill-btn" title="Acções">
